...
%doc %{geminstdir}/examples/performance.rb
...
* Wed Jan 09 2013 Josko Plazonic <plazonic@math.princeton.edu> - 1:2.3.15-1
- update to 2.3.15; due to requirements dropping tests for now - this version
  is only on maintenance and fixing this would require updating core os
  rpms
